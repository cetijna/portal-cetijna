export const escolaContent = {
  missao:
    "O CETI José Nogueira de Aguiar capacita cada estudante por meio de uma formação técnica completa e inspira o amor pelo aprendizado ao longo da vida.",
  sobre: {
    intro:
      "O Centro de Educação Técnica Integrada (CETI) José Nogueira de Aguiar é uma escola pública de ensino médio técnico integrado, localizada em Esperantina — PI. Desde 1976, forma estudantes com foco em educação, trabalho e cidadania.",
    pilares: [
      {
        title: "Educação",
        text: "Formação integral que une ensino médio e capacitação técnica.",
      },
      {
        title: "Trabalho",
        text: "Cursos técnicos alinhados às demandas do mercado e da comunidade.",
      },
      {
        title: "Cidadania",
        text: "Valores de responsabilidade, respeito e participação social.",
      },
    ],
    stats: [
      { value: "1976", label: "Ano de fundação" },
      { value: "4", label: "Cursos técnicos" },
  ...
  historia: [
    {
      ...
      text: "Início das atividades do CETI José Nogueira de Aguiar em Esperantina — PI.",
    },
    {
      year: "2006",
      title: "Expansão das salas digitais",
      text: "Ampliação da infraestrutura tecnológica e dos laboratórios de informática.",
    },
    {
      year: "2024",
      title: "Novo curso técnico integrado",
      text: "Expansão da oferta de cursos técnicos integrados ao ensino médio.",
    },
  ],
  equipe: [
    { role: "Direção Geral", name: "A definir", note: "Nome será atualizado em breve." },
    { role: "Direção Pedagógica", name: "A definir", note: "Nome será atualizado em breve." },
    { role: "Direção Administrativa", name: "A definir", note: "Nome será atualizado em breve." },
    { role: "Coordenação de Curso", name: "A definir", note: "Nome será atualizado em breve." },
  ],
  estrutura: [
    {
      title: "Salas de aula",
      text: "Ambientes climatizados e adequados ao ensino médio técnico.",
    },
    {
      title: "Laboratórios de informática",
      text: "Espaços equipados para práticas de desenvolvimento e informática.",
    },
    {
      title: "Biblioteca",
      text: "Acervo e espaço de estudo para a comunidade escolar.",
    },
    {
      title: "Área esportiva",
      text: "Espaço para atividades físicas, jogos escolares e interclasse.",
    },
    {
      title: "Administração",
      text: "Atendimento a alunos, famílias e servidores.",
    },
    {
      title: "Áreas comuns",
      text: "Pátio, refeitório e espaços de convivência.",
    },
  ],
  documentos: [
    {
      ...
      status: "Em breve",
      description: "Documento com as normas gerais de funcionamento da escola.",
    },
    {
      title: "Projeto Político-Pedagógico",
      status: "Em breve",
      description: "Diretrizes pedagógicas e missão institucional.",
    },
    {
      title: "Calendário Oficial",
      status: "Em breve",
      description: "Calendário letivo aprovado para o ano vigente.",
    },
    {
      title: "Manual do Aluno",
      status: "Em breve",
      description: "Orientações práticas para estudantes e famílias.",
    },
  ],
  cursos: ["Desenvolvimento de Sistemas", "Administração", "Informática", "Marketing"],
};

export const contatoContent = {
  email: "contato@cetijna.edu.br",
  endereco: "Esperantina — PI, Brasil",
  mapsEmbed:
    "https://maps.google.com/maps?q=-3.8936001,-42.2365656&t=&z=16&ie=UTF8&iwloc=&output=embed",
  mapsLink: "https://maps.app.goo.gl/EwTFCyee3ZYW6R6G6",
  redes: [
    { label: "Instagram", url: "#", note: "Link oficial será publicado em breve." },
    { label: "Facebook", url: "#", note: "Link oficial será publicado em breve." },
